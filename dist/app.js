...
var ShedOrganizer = /*#__PURE__*/function () {
  ...
  return _createClass(ShedOrganizer, [{
    ...
    key: "getAISuggestions",
    value: function () {
      var _getAISuggestions = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(layout) {
        var getSuggestions, result, suggestions, _t;
        return _regenerator().w(function (_context) {
          while (1) switch (_context.p = _context.n) {
            case 0:
              _context.p = 0;
              this.showLoadingIndicator();
              getSuggestions = firebase.functions().httpsCallable('getAISuggestions');
              _context.n = 1;
            ...
            case 1:
              result = _context.v;
              suggestions = result.data && result.data.suggestions;
              if (suggestions && suggestions.length) {
                this.showToast("\uD83E\uDD16 ".concat(suggestions.join(' ')));
              } else {
            ...
            case 2:
              _context.p = 2;
              _t = _context.v;
              console.error('AI suggestion error:', _t);
      ...
      function getAISuggestions(_x) {
        return _getAISuggestions.apply(this, arguments);
      }
